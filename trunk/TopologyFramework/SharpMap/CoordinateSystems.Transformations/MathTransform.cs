namespace Topology.CoordinateSystems.Transformations
{
    ...
    /// <see cref="T:Topology.CoordinateSystems.Transformations.ICoordinateTransformation" /> interface, and use the contained 
    ...
    public abstract class MathTransform : IMathTransform
    {
        ...
        /// D2R
        /// </summary>
        protected const double D2R = 0.017453292519943295;
        /// <summary>
        /// R2D
        /// </summary>
        protected const double R2D = 57.295779513082323;
