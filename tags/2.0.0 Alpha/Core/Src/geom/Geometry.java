...
import topology.io.WKTWriter;
import topology.operation.*;
import topology.operation.buffer.BufferOp;
import topology.operation.distance.DistanceOp;
import topology.operation.overlay.OverlayOp;
import topology.operation.overlay.snap.SnapIfNeededOverlayOp;
import topology.operation.predicate.RectangleIntersects;
import topology.operation.predicate.RectangleContains;
import topology.operation.relate.RelateOp;
import topology.operation.valid.IsValidOp;
import topology.util.Assert;
/**
    ...
    implements Cloneable, Comparable, Serializable
{
   ...
   *  interface.
   *
   *@return    the name of this <code>Geometry</code>s most specific <code>topology.geom</code>
   *      interface
   */
  ...
  protected void checkNotGeometryCollection(Geometry g) {
    ...
    if (g.getClass().getName().equals("topology.geom.GeometryCollection")) {
