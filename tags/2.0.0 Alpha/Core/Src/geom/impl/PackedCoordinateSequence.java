package topology.geom.impl;

import topology.geom.*;
    ...
    implements CoordinateSequence
{
   ...
   */
	protected System.WeakReference coordRef;

  /**
   * @see topology.geom.CoordinateSequence#getDimension()
   */
  ...
  /**
   * @see topology.geom.CoordinateSequence#getCoordinate(int)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequence#toCoordinateArray()
   */
...
// testing - never cache
	...
	coordRef = new System.WeakReference(coords);
    return coords;
  }
  ...
  private Coordinate[] getCachedCoords() {
    if (coordRef != null) {
	  ...
	  Coordinate[] coords = (Coordinate[]) coordRef.get_Target();
      if (coords != null) {
        return coords;
      } else {
        // System.out.print("-");
  ...
  /**
   * @see topology.geom.CoordinateSequence#getX(int)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequence#getY(int)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequence#getOrdinate(int, int)
   */
  ...
  public static class Double extends PackedCoordinateSequence {
    ...
    /**
     * @see topology.geom.CoordinateSequence#size()
     */
    public int size() {
    ...
    /**
     * @see topology.geom.PackedCoordinateSequence#setOrdinate(int,
     *      int, double)
     */
