    ...
    CoordinateSequenceFactory
{
  ...
  /**
   * @see topology.geom.CoordinateSequenceFactory#create(topology.geom.Coordinate[])
   */
  ...
  /**
   * @see topology.geom.CoordinateSequenceFactory#create(topology.geom.CoordinateSequence)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequenceFactory#create(double[],
   *      int)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequenceFactory#create(float[],
   *      int)
   */
  ...
  /**
   * @see topology.geom.CoordinateSequenceFactory#create(int, int)
   */
