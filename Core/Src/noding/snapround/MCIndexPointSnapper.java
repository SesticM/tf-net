package topology.noding.snapround;

import java.util.*;
import topology.geom.*;
import topology.noding.*;
import topology.algorithm.LineIntersector;
import topology.index.chain.*;
import topology.index.*;
import topology.index.strtree.STRtree;
import topology.index.quadtree.Quadtree;
